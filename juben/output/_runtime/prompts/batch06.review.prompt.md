...
- batch_id: batch06
- episodes: EP-26, EP-27, EP-28, EP-29, EP-30
- sampled episodes:
- EP-26
- EP-27
...
- Batch brief：`harness/project/batch-briefs/batch06_EP26-30.md`
...
- JSON：`harness/project/reviews/batch06.review.json`
- Markdown：`harness/project/reviews/batch06.review.md`
...
- `.\~review.cmd batch06 PASS --reviewer <name>`
- `.\~review.cmd batch06 FAIL --reviewer <name> --reason "..."`
