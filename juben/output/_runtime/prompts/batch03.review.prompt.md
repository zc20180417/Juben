...
- Batch brief：`harness/project/batch-briefs/batch03_EP11-15.md`
...
- JSON：`harness/project/reviews/batch03.review.json`
- Markdown：`harness/project/reviews/batch03.review.md`
...
- `python _ops/controller.py batch-review-done batch03 PASS --reviewer <name>`
- `python _ops/controller.py batch-review-done batch03 FAIL --reviewer <name> --reason "..."`
