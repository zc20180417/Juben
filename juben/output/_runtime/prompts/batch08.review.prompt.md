...
- batch_id: batch08
- episodes: EP-36, EP-37, EP-38, EP-39, EP-40
- sampled episodes:
- EP-36
- EP-37
...
- Batch brief：`harness/project/batch-briefs/batch08_EP36-40.md`
...
- JSON：`harness/project/reviews/batch08.review.json`
- Markdown：`harness/project/reviews/batch08.review.md`
...
- `.\~review.cmd batch08 PASS --reviewer <name>`
- `.\~review.cmd batch08 FAIL --reviewer <name> --reason "..."`
