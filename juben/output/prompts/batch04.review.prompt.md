...
- Batch brief：`harness/project/batch-briefs/batch04_EP16-20.md`
...
- JSON：`harness/project/reviews/batch04.review.json`
- Markdown：`harness/project/reviews/batch04.review.md`
...
- `python _ops/controller.py batch-review-done batch04 PASS --reviewer <name>`
- `python _ops/controller.py batch-review-done batch04 FAIL --reviewer <name> --reason "..."`
