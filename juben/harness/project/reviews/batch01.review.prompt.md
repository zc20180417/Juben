...
- Batch brief：`harness/project/batch-briefs/batch01_EP01-05.md`
...
- JSON：`harness/project/reviews/batch01.review.json`
- Markdown：`harness/project/reviews/batch01.review.md`
...
- `python _ops/controller.py batch-review-done batch01 PASS --reviewer <name>`
- `python _ops/controller.py batch-review-done batch01 FAIL --reviewer <name> --reason "..."`
