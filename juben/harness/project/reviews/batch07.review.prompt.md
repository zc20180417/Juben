...
- batch_id: batch07
- episodes: EP-31, EP-32, EP-33, EP-34, EP-35
- sampled episodes:
- EP-31
- EP-32
...
- Batch brief：`harness/project/batch-briefs/batch07_EP31-35.md`
...
- JSON：`harness/project/reviews/batch07.review.json`
- Markdown：`harness/project/reviews/batch07.review.md`
...
- `.\~review.cmd batch07 PASS --reviewer <name>`
- `.\~review.cmd batch07 FAIL --reviewer <name> --reason "..."`
