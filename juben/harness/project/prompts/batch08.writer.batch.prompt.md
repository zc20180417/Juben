...
必读输入：
- harness/project/state/batch-context/batch08.writer-context.json
- drafts/episodes/EP-35.md

权威输入：
- `harness/project/batch-briefs/batch08_EP36-40.md` 决定每集任务与 beats。
...
目标文件：
- EP-36 -> drafts/episodes/EP-36.md
  - excerpt: harness/project/state/source-excerpts/batch08/EP-36.source.json
  - 场次：首场 `场36-1`；整集至少 2 场；按 beats 与 source 推进自然拆场
  - beats：【动作】陆行川走进停产设备厂，机器蒙尘，工人守在门口。; 【阻力】债务、欠薪、技术人员流失同时压上来。; 【信息】沈砚山看出设备改造能解决棠源主厂瓶颈。; 【钩子】老工程师说：你买得到厂，未必留得住图纸。；`【信息】/【关系】/【动作】/【钩子】` 不能缺
  - knowledge_boundary：设备厂工人只知道新买主要来谈，不知道棠源资金压力。; 沈砚山只看到技术价值，不掌握全部债务。
- EP-37 -> drafts/episodes/EP-37.md
  - excerpt: harness/project/state/source-excerpts/batch08/EP-37.source.json
  - 场次：首场 `场37-1`；整集至少 2 场；按 beats 与 source 推进自然拆场
  - beats：【动作】秦峥查封设备厂资料室，发现关键图纸缺页。; 【阻力】边境客户拖延回款，韩策要求暂停下一单。; 【选择】陆行川不抢进度，先按合同追责、保住回款和图纸线索。; 【钩子】许望舒认出缺失图纸对应的正是速冻口感问题。；`【信息】/【关系】/【动作】/【钩子】` 不能缺
  - knowledge_boundary：许望舒只知道图纸可能有用，不知道最终科研合作。; 客户不知道棠源内部资金紧张。
- EP-38 -> drafts/episodes/EP-38.md
  - excerpt: harness/project/state/source-excerpts/batch08/EP-38.source.json
  - 场次：首场 `场38-1`；整集至少 2 场；按 beats 与 source 推进自然拆场
  - beats：【动作】叶承稷把样品复热后切开，让陆行川看失败截面。; 【阻力】许望舒要求研发失败不能算个人责任，梅知夏追问预算边界。; 【选择】陆行川接受实验线周期和失败成本。; 【钩子】叶承稷同意合作，但要求第一批数据公开给团队看。；`【信息】/【关系】/【动作】/【钩子】` 不能缺
  - knowledge_boundary：科研人员知道棠源有诚意，不知道商业扩张全貌。; 团队不知道科研投入多久见效。
- EP-39 -> drafts/episodes/EP-39.md
  - excerpt: harness/project/state/source-excerpts/batch08/EP-39.source.json
  - 场次：首场 `场39-1`；整集至少 2 场；按 beats 与 source 推进自然拆场
  - beats：【动作】梅知夏要求先报问题，再报增长。; 【信息】渠道、车队、风控、设备、科研各线都有结果，但没有一条完全轻松。; 【阻力】设备瓶颈导致返工，乔南枝担心货架断供。; 【钩子】陆行川准备定下一阶段方向时，外面有人送来一份榜单传真。；`【信息】/【关系】/【动作】/【钩子】` 不能缺
  - knowledge_boundary：各负责人只掌握自己板块。; 富豪榜消息还未公开解释。
- EP-40 -> drafts/episodes/EP-40.md
  - excerpt: harness/project/state/source-excerpts/batch08/EP-40.source.json
  - 场次：首场 `场40-1`；整集至少 2 场；按 beats 与 source 推进自然拆场
  - beats：【动作】陆振海摸着旧冷库门牌，想起当初差点盖下的转让章。; 【情绪】团队短暂沉默，不是炫富，而是意识到棠源被更大市场看见。; 【结果】陆行川定下下一阶段：设备升级、科研实验线、区域渠道、风控退出线。; 【钩子】传真另一页显示全国品牌已注意到棠源，新的竞争刚开始。；`【信息】/【关系】/【动作】/【钩子】` 不能缺
  - knowledge_boundary：团队知道棠源进入更大牌桌，但不知道后续全国竞争细节。; 陆振海终于理解儿子保住的不是冷库，而是方向盘。
